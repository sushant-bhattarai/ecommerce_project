            ...
            <div class="col-xs-12 col-md-4 col-md-offset-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row"><br>
                            <br><h3 class="text-center">Delivery Details</h3>
                    ...
                    <div class="panel-body">
                        <form role="form" action="server.php" method="post">
                            <div class="row">
                                <div class="col-xs-7 col-md-7">
                                    <div class="form-group">
                                        <label><span class="hidden-xs">Receiver Name</span></label>
                                        <input type="text" class="form-control" placeholder="eg. John Doe" name="cust_name" required />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-7 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="eg. john@gmail.com" name="email" required/>
                                    </div>
                                </div>
                                <div class="col-xs-5 col-md-5 pull-right">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-xs-7 col-md-7">
                                    <div class="form-group">
                                        <label><span class="hidden-xs">Delivery Address</span></label>
                                        <input type="text" class="form-control" placeholder="eg. Chyasal" name="address" required/>
                                    </div>
                                </div>
                                <div class="col-xs-5 col-md-5 pull-right">
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-warning btn-lg btn-block" type="submit" name="process_payment_cod">Process Payment</button>
                            </div>
                        </div><br>
                    </div>
                    </form>
